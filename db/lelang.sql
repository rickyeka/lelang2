...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 02, 2019 at 09:35 PM
...
(23, 'JT009', 17, 'jepara', 'jatitpknew.jpg', 'JATI TPK NYA PAK ALFAN', 28000000, 'Hanya jualan untuk menafkahi keluarga', '2019-07-02', '2019-07-03', 0, 0);
...
(17, '09312121', 'jepara', 'alfanjuniyanto', 'alfanju', '1234', '2019-07-02 16:04:07', 1);
...
--
ALTER TABLE `tbl_barang_lelang`
  MODIFY `id_barang_lelang` int(1) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `tbl_pelelang`
  MODIFY `id_pelelang` int(2) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=18;
COMMIT;
